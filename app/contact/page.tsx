        ...
        <div className="container-custom px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {contactInfo.map((info, index) => (
              ...
              >
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-primary to-primary-light rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg">
                  <info.icon className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
                </div>
                <h3 className="text-lg sm:text-xl font-semibold text-secondary mb-3 sm:mb-4">{info.title}</h3>
                <p className="text-base sm:text-lg font-medium text-primary mb-2">{info.content}</p>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <div className="flex items-start">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-primary to-primary-light rounded-xl flex items-center justify-center mr-3 sm:mr-4 mt-1 shadow-lg">
                    <MessageCircle className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-base sm:text-lg font-semibold text-secondary mb-2 sm:mb-3">{faq.question}</h3>
        ...
        <div className="container-custom px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto">
              <a href="#contact-form" className="btn-large bg-white text-primary hover:bg-gray-100 text-sm sm:text-base">
                Get Started Now
              </a>
              <a href="/courses" className="btn-large border-2 border-white text-white hover:bg-white hover:text-primary text-sm sm:text-base">
                View Our Courses
              </a>
            </div>
          </motion.div>
